<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="Report.aspx.cs" Inherits="LibraryManagementSystem.WebForm22" %>
...
<asp:Content ID="Content6" ContentPlaceHolderID="MainSection" runat="server">
    <form runat="server">
        ...
        <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" SelectMethod="GetData" TypeName="LibraryManagementSystem.LMSDataSetTableAdapters.tbl_studentTableAdapter"></asp:ObjectDataSource>
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetData" TypeName="LibraryManagementSystem.LMSDataSetTableAdapters.tbl_bookTableAdapter"></asp:ObjectDataSource>
    </form>
</asp:Content>
