...
<asp:Content ID="Content4" ContentPlaceHolderID="LeftSideBar" runat="server">
    <div>
        <ul class="pager">
            ...
            <li>
                <a href="ManageStudent.aspx">Edit Student</a>
            </li>
        </ul>
    </div>
</asp:Content>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            <div class="form-group">
                                ...
                                <asp:TextBox CssClass="form-control" ID="txtUsername" runat="server" AutoPostBack="True" OnTextChanged="txtUsername_TextChanged"></asp:TextBox>
                                ...
                                <asp:Label ID="lblCheckUserName" runat="server" Text="" CssClass=""></asp:Label>
